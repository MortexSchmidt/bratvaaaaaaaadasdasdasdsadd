...
async def cmd_help(message: Message):
    await message.answer(
        ...
        "/vote @user - голосовать днем\n"
        "/kill_mafia @user - убить ночью (мафия)\n"
        "/heal_mafia @user - лечить ночью (доктор)\n"
        "/check_mafia @user - проверить ночью (детектив)\n"
        ...
        "трахнуть, изнасиловать, поцеловать, обнять, засосать, убить, пукнуть, минет, секс\n"
